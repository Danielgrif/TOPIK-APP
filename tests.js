// @ts-check
import { Scheduler } from './js/core/scheduler.js';
import { levenshtein, parseBilingualString, generateDiffHtml } from './js/utils/utils.js';
import { QuizStrategies } from './js/ui/quiz_strategies.js';
...
export async function runTests() {
     ...
     * @param {number} max
     */
    const assertRange = (desc, actual, min, max) => {
    ...
    try {
        ...
        state.dataStore = [{id:1, word_kr:'A', translation:'A'}, {id:2, word_kr:'B', translation:'B'}, {id:3, word_kr:'C', translation:'C'}, {id:4, word_kr:'D', translation:'D'}, {id:5, word_kr:'E', translation:'E'}];
        
        const mockWord = { id: 1, word_kr: 'Test', translation: 'Тест' };
