import { SM2State } from '../types/index.ts';
import { Word, UserStats, WordHistoryItem, DailyChallenge, StudyGoal, MusicTrack } from '../types/index.ts';
...
try {
    ...
    if (state.dailyChallenge.streak === undefined) state.dailyChallenge.streak = 0;
