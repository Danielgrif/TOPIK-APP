 ...
 */
export function debounce<T extends (...args: any[]) => any>(fn: T, wait: number = 200): (...args: Parameters<T>) => void {
 ...
 */
export function parseBilingualString(str: string | null | undefined): { kr: string; ru: string } {
...
export function playTone(type: ToneType = 'success', duration: number = 120): Promise<void> {
 ...
 */
export function speak(t: string | null, url: string | null | undefined): Promise<void> {
