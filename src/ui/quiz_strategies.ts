...
function handleChoiceClick(isCorrect: boolean, btn: HTMLElement, onAnswer: (isCorrect: boolean, autoAdvance?: boolean) => void) {
...
interface Strategy {
    render: (word: Word, container: HTMLElement, onAnswer: (isCorrect: boolean | null, autoAdvance?: boolean, forceNext?: boolean) => void, qEl: HTMLElement) => void;
    _renderInput?: (word: Word, container: HTMLElement, onAnswer: (isCorrect: boolean | null, autoAdvance?: boolean, forceNext?: boolean) => void) => void;
    _addNextBtn?: (container: HTMLElement, onAnswer: (isCorrect: boolean | null, autoAdvance?: boolean, forceNext?: boolean) => void) => void;
}
...
export const QuizStrategies: Record<string, Strategy> = {
    ...
    'scramble': {
        render(word, container, onAnswer, qEl) {
            ...
            container.innerHTML = '';
            let currentAnswer: Array<{text: string, id: number}> = [];
    ...
    'synonyms': {
        render(word, container, onAnswer, qEl) {
            ...
            const options: Array<{text: string, correct: boolean}> = [{ text: correctText, correct: true }];
    ...
    'pronunciation': {
        render(word, container, onAnswer, qEl) {
            ...
            btn.onclick = () => {
                checkPronunciation(word.word_kr, btn, (similarity: number, text: string) => {
