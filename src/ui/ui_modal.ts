...
export function openModal(modalId: string) {
    ...
    if (modalId === 'profile-modal') {
        ...
        const hanjaCheck = document.getElementById('hanja-setting-check') as HTMLInputElement;
        if (hanjaCheck) hanjaCheck.checked = state.hanjaMode;
        const darkModeCheck = document.getElementById('dark-mode-toggle-switch') as HTMLInputElement;
        ...
        const musicCheck = document.getElementById('background-music-check') as HTMLInputElement;
        if (musicCheck) musicCheck.checked = state.backgroundMusicEnabled;
        const musicVolumeSlider = document.getElementById('background-music-volume-slider') as HTMLInputElement;
        if (musicVolumeSlider) musicVolumeSlider.value = String(state.backgroundMusicVolume);
    ...
    try { lastFocusedElement = document.activeElement as HTMLElement; } catch (e) { lastFocusedElement = null; }
...
export function openConfirm(message: string, onYes: () => void, options: ConfirmOptions = {}) {
